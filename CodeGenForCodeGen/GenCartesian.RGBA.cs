...
[Generator]
public class GenCartesianRGBA : ISourceGenerator
{
    public static readonly char[] xyzw = { 'r', 'g', 'b', 'a' };
...
{{
    public static readonly char[] rgba = {{ 'r', 'g', 'b', 'a' }};

    public static readonly char[,,] rgba_cartesian2 = {{ {ca2} }};

    public static readonly char[,,] rgba_cartesian3 = {{ {ca3} }};

    public static readonly char[,,] rgba_cartesian4 = {{ {ca4} }};
}}
", Encoding.UTF8);
        context.AddSource("cartesian.rgba.gen.cs", source);
    }
}

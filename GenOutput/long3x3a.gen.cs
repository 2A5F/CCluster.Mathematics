...
[Serializable]
[JsonConverter(typeof(Long3x3AJsonConverter))]
    ...
    IMatrix3x3<long>, IMatrixSelf<long3x3a>, IMatrixIdentity<long3x3a>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public static long3x3a transpose(long3x3a v) => new(
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining | MethodImplOptions.AggressiveOptimization)]
    public readonly long3x3a transpose() => transpose(this);
...
public class Long3x3AJsonConverter : JsonConverter<long3x3a>
{
    private static readonly Type v_type = typeof(long3a);

    public override long3x3a Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        Unsafe.SkipInit(out long3x3a result);
    ...
    public override void Write(Utf8JsonWriter writer, long3x3a value, JsonSerializerOptions options)
    {
